 ...
 * <li>{@code InputTriangle.n} stores 3 neighbor triangle indices ({@code -1} for boundary).</li>
 * <li>{@code InputTriangle.c} stores 3 edge constraints ({@code null} for unconstrained).</li>
 * <li>Triangle side {@code i} is opposite vertex {@code v[i]}; its edge endpoints are
 * {@code v[(i+1)%3]} and {@code v[(i+2)%3]}.</li>
 * </ul>
 * <p>
